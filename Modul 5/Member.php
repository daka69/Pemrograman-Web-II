...
<body>
    <div class="container">
        <h2>Data Member</h2>
        <div class="nav-links">
            <a href="Member.php" class="active">Data Member</a>
        ...
        <table>
            ...
            <tr>
                ...
                <td class="action-links">
                    ...
                    <a href="Member.php?delete=<?= $m['id_member'] ?>" class="btn-delete" onclick="return confirm('Yakin ingin menghapus member ini?')">Hapus</a>
                </td>
            </tr>
            <?php endforeach; ?>
        </table>
